...
<div class='alto-sm ocultar-desborde'>
<!-- Posibles imágenes de cabecera para destacar en forma random para cada info de docencia -->
...
<ul class='sin-relleno margen-sup-sm margen-inf-xs' id="breadcrumb">
  ...
  <li><a class='blanco'>Información</a></li>
     ...
     <h2 class='entry-title negro-fundido md gruesa condensado ancho-auto'>Inicio de clases – Escuela de Arquitectura y Diseño</h2>
...
<div class='col-md-3 col-sm-3'>
    ...
    <h6 class='xs interletraje-xs negro condensado gruesa margen-sup altas'><i class='icn icn-twitter relleno-der-xs'></i>Twitter</h6>
</div>
</aside> <!-- fin de fila -->
</div>
</div>