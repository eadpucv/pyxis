...
<div class='fila'>
    ...
    <div id='sub-componentes'>
      <div class='pag sin-relleno'>
        <ul class="nav nav-tabs" role="tablist" id="tabla-contenido">
          <li class="active"><a id='subiendo-1' href="#modal" role="tab" data-toggle="tab">Modal</a></li>
          ...
          <li><a id='subiendo-4' class='condensado' href="#affix" role="tab" data-toggle="tab">Affix</a></li>
  ...
  &lt;a class="btn" id="popover-test" data-content="Este es un popover..." data-toggle="popover" data-original-title="Titulo de un popover">Elemento con Popover&lt;/a>
      ...
      <div class="tab-pane fade" id="affix">
        ...
        <h4 class='pizarra gruesa'>Affix</h4>
