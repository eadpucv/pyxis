...
<div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
    <div id='sub-componentes'>
        <div class='pag sin-relleno'>
            <ul class="nav nav-tabs" role="tablist" id="tabla-contenido">
                <li class="active"><a id='subiendo-1' class='condensado' href="#paleta-gamma" role="tab" data-toggle="tab">Stampa Regular</a></li>
                <li><a id='subiendo-2' class='condensado' href="#paleta-adicional" role="tab" data-toggle="tab">Stampa Ligera</a></li>
                <li class='subir'><a href="#topbar"><i class="icn icn-stampa"></i></a></li>
            </ul>
        </div>
    </div>
    ...
    <h5 class='pizarra fino linea-lateral'>íconos tipográficos</h5>
    <!-- tipográficos -->
    <div class='fila'>
    <ul>
    <li class="caja-icono"> 
    ...
    <h5 class='pizarra fino linea-lateral'>Íconos direccionales</h5>
    <div class='fila'>
    <!-- direccionales -->
    <ul>
    <li class="caja-icono"> 
    ...
    <h5 class='pizarra fino linea-lateral'>Íconos temporales</h5>
    <!-- temporales -->
    <div class='fila'>
    <ul>
    <li class="caja-icono"> 
    ...
    <h5 class='pizarra fino linea-lateral'>Íconos enumeradores</h5>
    <div class='fila'>
    <!-- enumeradores -->
    <ul>
    <li class="caja-icono"> 
    ...
    <h5 class='pizarra fino linea-lateral'>Íconos de aplicación E[ad]</h5>
    <!-- aplicación ead -->
    <div class='fila'>
    <ul>
    <li class="caja-icono"> 
    ...
    <h5 class='pizarra fino linea-lateral'>Íconos de aplicaciones externas</h5>
    <!-- redes sociales -->
    <div class='fila'>
    <ul>
     <li class="caja-icono"> 
